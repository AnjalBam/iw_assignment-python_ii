...
class Customer:
    ...
    def check_balance(self):
        ...
        """
        return f'balance({self.__ac_no}): {self.__balance}/-'
...
customer_1 = Customer('Ram Bahadur', '2201056',
                      'ram@ram.com', 'Babarmahal, Kathmandu',
                      1000
                      )
...
# update name
customer_1.update_name('Ram Bahadur Shahi')
# updated name
print(customer_1)
print(customer_1.check_balance())

print(customer_1.get_details())
customer_1.update_email('rambahadur2020@ram.com')  # updates email
customer_1.update_address('Pepsi Cola, Kathmandu')

# customer deposits the balance
customer_1.add_balance(100000)
print(customer_1.check_balance())

customer_1.withdraw_balance(20000)
print(customer_1.check_balance())
